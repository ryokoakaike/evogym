...
Matrix <double, 2, Dynamic> Environment::get_pos_at_time(long int sim_time) {
...
Matrix <double, 2, Dynamic> Environment::get_vel_at_time(long int sim_time) {
...
Matrix <double, 2, Dynamic> Environment::object_pos_at_time(long int sim_time, string object_name) {
...
Matrix <double, 2, Dynamic> Environment::object_vel_at_time(long int sim_time, string object_name) {
