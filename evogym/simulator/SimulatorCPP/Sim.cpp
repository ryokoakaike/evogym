...
Matrix <double, 2, Dynamic> Sim::pos_at_time(long int sim_time) {
	return environment.get_pos_at_time(sim_time);
}
Matrix <double, 2, Dynamic> Sim::vel_at_time(long int sim_time) {
...
Matrix <double, 2, Dynamic> Sim::object_pos_at_time(long int sim_time, string object_name) {
	return environment.object_pos_at_time(sim_time, object_name);
}
Matrix <double, 2, Dynamic> Sim::object_vel_at_time(long int sim_time, string object_name) {
